...
from.yahoo.flickr.api=function(d,g){d=d;var c={};c.api_call=function(a,b,e){b.api_key=d;b.method=a;b.format="json";b.nojsoncallback=1;if(b.auth_token){api_sig=this.sign_args(b);b.api_sig=api_sig}a=new FormData;for(var f in b)a.append(f,b[f]);var h=new XMLHttpRequest;h.open("POST","http://api.flickr.com/services/rest/",true);h.onreadystatechange=function(){if(h.readyState===4)if(e)try{rsp=JSON.parse(h.responseText);e(rsp)}catch(i){e({stat:"error",error:{code:999,message:"failed to parse JSON"}})}};
h.send(a)};c.upload=function(a,b){b.api_key=d;api_sig=this.sign_args(b);b.api_sig=api_sig;b.photo=a;if(typeof a==="string")return this._upload_binary(b);return this._upload_blob(b)};c.sign_args=function(a){var b=[];for(var e in a)b[b.length]=[e,a[e]];b.sort(function(f,h){if(f[0]==h[0])return 0;if(f[0]<h[0])return-1;return 1});a=g;for(e=0;e<b.length;e++){a+=b[e][0];a+=b[e][1]}return hex_md5(a)};c._upload_blob=function(a){var b=new FormData;for(var e in a)b.append(e,a[e]);a=new XMLHttpRequest;a.open("POST",
"http://api.flickr.com/services/upload/",true);a.onreadystatechange=function(){};a.send(b)};c._upload_binary=function(a){var b=this._generate_multipart_boundary(),e=new XMLHttpRequest;e.open("POST","http://api.flickr.com/services/upload/",true);e.onreadystatechange=function(){};e.setRequestHeader("Content-Type","multipart/form-data; boundary="+b);e.sendAsBinary(this._build_multipart_message(a,b))};c._generate_multipart_boundary=function(){return"---------------------------"+(new Date).getTime()};
c._build_multipart_message=function(a,b){var e=[];for(var f in a){var h="";if(f=="photo"){h+="Content-Disposition: form-data; ";h+='name="photo"; ';h+='filename="photo"\r\n';h+="Content-Type: application/octet-stream\r\n\r\n"}else{h+="Content-Disposition: form-data; ";h+='name="'+f+'"\r\n\r\n'}h+=a[f]+"\r\n";e.push(h)}f="--"+b+"\r\n";f+=e.join("--"+b+"\r\n");f+="--"+b+"--\r\n";return f};return c};
if(XMLHttpRequest.prototype.sendAsBinary==undefined)XMLHttpRequest.prototype.sendAsBinary=function(d){d=Array.prototype.map.call(d,function(g){return g.charCodeAt(0)&255});this.send((new Uint8Array(d)).buffer)};
